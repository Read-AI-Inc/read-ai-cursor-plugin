...
1. Install **Read AI** from the [Visual Studio Marketplace](https://marketplace.visualstudio.com/), or sideload the `.vsix`.
2. Open Copilot Chat → Agent mode.
3. When prompted, complete OAuth with your Read AI account.
4. Confirm at least one tool appears (for example `list_meetings`).
...
- Issues: use your team’s internal tracker for this private repo
